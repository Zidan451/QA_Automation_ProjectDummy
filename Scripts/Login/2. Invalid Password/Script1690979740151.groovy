...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_TestProject Demo/input_Password_password'), 'tzH6RvlfSTg=')

WebUI.click(findTestObject('Object Repository/Page_TestProject Demo/button_Login'))

WebUI.verifyElementVisible(findTestObject('Page_TestProject Demo/div_Password is invalid'))
