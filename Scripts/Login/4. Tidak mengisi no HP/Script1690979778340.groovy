...
WebUI.setText(findTestObject('Object Repository/Page_TestProject Demo/input_Email_email'), 'zidan@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_TestProject Demo/button_Save'))

WebUI.verifyElementVisible(findTestObject('Page_TestProject Demo/div_Please enter a valid phone number'))
